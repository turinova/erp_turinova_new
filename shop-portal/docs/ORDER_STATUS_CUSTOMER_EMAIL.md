...
- **Változók:** `{{order_items_table}}` — szerver generálja a tételeket (kép, név, cikkszám, menny., sor bruttó; lábléc: rendelés bruttó végösszege). Csak a **levéltörzsben** használja (tárgyban figyelmen kívül hagyjuk).
