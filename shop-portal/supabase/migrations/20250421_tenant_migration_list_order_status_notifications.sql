-- Append order status notification migrations to admin tenant migration list.
-- Run on ADMIN DATABASE (where get_tenant_pending_migrations lives).
-- After running 20250421_order_status_email_notifications.sql and
-- 20250421_add_order_status_notifications_page_permissions.sql on tenant DBs.
