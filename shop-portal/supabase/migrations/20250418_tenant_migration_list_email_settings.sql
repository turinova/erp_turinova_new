-- Add email management migrations to tenant migration list
-- Run on ADMIN DATABASE (where get_tenant_pending_migrations lives).
-- After running 20250418_create_email_management_tables and 20250418_add_email_settings_page_permissions on tenant DBs, run this.
