-- Add awaiting_carrier + shipping_methods credentials migrations to tenant migration list
-- Run on ADMIN DATABASE (where get_tenant_pending_migrations lives).
-- After running 20250416_orders_status_awaiting_carrier and 20250416_shipping_methods_carrier_credentials on tenant DBs,
