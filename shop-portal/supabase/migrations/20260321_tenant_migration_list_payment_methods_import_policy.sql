-- Append payment_methods import policy migration to admin tenant migration list.
-- Run on ADMIN DATABASE (where get_tenant_pending_migrations lives).
-- After running 20260320_payment_methods_import_payment_policy.sql on tenant DBs.
