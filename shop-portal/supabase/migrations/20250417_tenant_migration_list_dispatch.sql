-- Add dispatch page migration to tenant migration list
-- Run on ADMIN DATABASE. After running 20250417_add_dispatch_page_to_permissions on tenant DBs, run this.
