...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Checkbox, TextField, InputAdornment, Button, CircularProgress, Dialog, DialogTitle, DialogContent, DialogActions, Switch, Grid } from '@mui/material'
  ...
  const handleOpenPermissions = async (user: User) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('[PERMISSIONS] /users permission:', permissionsMap.get('/users'))
        ...
        pages.forEach(page => {
          ...
          if (page.path === '/home' || page.path === '/users') {
