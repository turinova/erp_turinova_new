...
export default function CompanyNewForm({ customerGroups }: CompanyNewFormProps) {
    ...
    <Box>
      ...
      <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Hozzon létre egy új céget. Később hozzáadhat címeket, bankszámlákat és más adatokat.
          </Typography>
        </Box>
        <Button
          variant="contained"
      ...
      <Alert severity="info" sx={{ mt: 3 }}>
        <Typography variant="body2">
          A cég létrehozása után hozzáadhat címeket, bankszámlákat és más adatokat a részletek oldalon.
        </Typography>
      </Alert>
    </Box>
  )
