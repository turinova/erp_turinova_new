...
/**
 * GET /api/customers/persons/[id]/addresses
...
export async function GET(
  ...
  try {
    ...
    console.error('Error in person addresses GET API:', error)
    return NextResponse.json(
...
/**
 * POST /api/customers/persons/[id]/addresses
...
export async function POST(
  ...
  try {
    ...
    if (error) {
      console.error('Error creating person address:', error)
      return NextResponse.json(
    ...
    console.error('Error in person addresses POST API:', error)
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    )
