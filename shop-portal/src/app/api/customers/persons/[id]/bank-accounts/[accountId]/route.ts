...
/**
 * GET /api/customers/persons/[id]/bank-accounts/[accountId]
 * Fetch a single bank account for a person
 */
export async function GET(
  ...
  try {
    ...
    // Fetch bank account (check both person_id and customer_entity_id for backward compatibility)
    ...
    console.error('Error in person bank account GET API:', error)
    return NextResponse.json(
...
/**
 * PUT /api/customers/persons/[id]/bank-accounts/[accountId]
 * Update a bank account for a person
 */
export async function PUT(
  ...
  try {
    ...
    if (error) {
      console.error('Error updating person bank account:', error)
      return NextResponse.json(
    ...
    console.error('Error in person bank account PUT API:', error)
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    )
...
/**
 * DELETE /api/customers/persons/[id]/bank-accounts/[accountId]
 * Soft delete a bank account for a person
 */
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error('Error deleting person bank account:', error)
      return NextResponse.json(
    ...
    console.error('Error in person bank account DELETE API:', error)
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    )
