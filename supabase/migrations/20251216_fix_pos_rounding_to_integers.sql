-- Fix create_pos_sale function to round all totals to integers (whole forints)
-- This ensures consistency with Számlázz.hu requirements and invoice creation
-- Számlázz.hu requires integers for nettoErtek and afaErtek in HUF invoices
