-- Fix create_pos_sale function to use stored gross_price directly for accessories
-- For accessories: total_gross = unit_price_gross * quantity (preserves stored gross_price)
-- For materials/linear_materials: keep current calculation from net_price + VAT
-- This ensures accessories with stored gross_price (e.g., 6610) calculate correctly
-- Date: 2026-01-23
...
BEGIN
  ...
  LOOP
    ...
    -- Calculate totals: For accessories, use gross_price directly; for others, calculate from net
