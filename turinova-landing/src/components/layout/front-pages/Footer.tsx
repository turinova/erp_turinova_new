          ...
          <Grid container rowSpacing={10} columnSpacing={12}>
            ...
            <Grid size={{ xs: 12, sm: 4, lg: 3 }}>
              ...
              <div className='flex flex-col gap-4'>
                ...
                <Typography component={Link} href='http://localhost:3001/login' color='text.secondary' className='hover:text-primary'>
                  Bejelentkezés
                </Typography>
                <Typography component={Link} href='http://localhost:3001/register' color='text.secondary' className='hover:text-primary'>
                  Regisztráció
                </Typography>
              </div>
            </Grid>
      ...
      <div className='bg-white border-t border-gray-200'>
        ...
        >
          ...
          <div className='flex flex-wrap gap-4 items-center'>
            <Typography 
              component={Link} 
              href='http://localhost:3001/terms-and-conditions' 
            ...
            <Typography 
              component={Link} 
              href='http://localhost:3001/cookie-policy' 
              color='text.secondary' 
              className='hover:text-primary'
              variant='body2'
            >
