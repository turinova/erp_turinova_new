...
export default function EdgeMaterialDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const router = useRouter()
  const resolvedParams = use(params)
  
  const [edgeMaterial, setEdgeMaterial] = useState<EdgeMaterial | null>(null)
  ...
  // Load edge material data from API
  useEffect(() => {
