...
import { getLinearMaterialById, getAllBrandsForLinearMaterials, getAllVatRatesForLinearMaterials, getAllCurrenciesForLinearMaterials } from '@/lib/supabase-server'
...
export default async function LinearMaterialEditPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [brands, vatRates, currencies] = await Promise.all([
