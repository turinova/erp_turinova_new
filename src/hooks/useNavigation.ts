    ...
    const filterMenuItems = (items: VerticalMenuDataType[]): VerticalMenuDataType[] => {
      return items.filter(item => {
        ...
        if ('href' in item && item.href) {
          ...
          if (item.href === '/materials' || item.href === '/media' || item.href === '/feetypes' || item.href === '/machines' || item.href === '/accessories' || item.href === '/quotes' || item.href === '/orders' || item.href === '/scanner') {
