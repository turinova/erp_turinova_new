...
/**
 * POST /api/orders/sms-eligible
 * Check which orders are eligible for SMS notifications
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[SMS] Found ${smsEligibleOrders.length} SMS-eligible orders out of ${orders?.length || 0}`)
