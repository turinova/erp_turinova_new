...
function budapestYesterdayYmd(): string {
  ...
  // Use UTC math on a calendar day key to avoid DST/timezone pitfalls
...
export async function GET(request: NextRequest) {
  try {
    ...
    while (true) {
      ...
      if (error) {
        console.error('Error fetching past remaining edge banding data:', error)
    ...
    console.error('Error in edge banding remaining past API:', e)
