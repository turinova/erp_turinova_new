...
export default function AccessoriesListClient({ 
  ...
  const [accessoryToPrint, setAccessoryToPrint] = useState<AccessoryLabelPrintPayload | null>(null)
  ...
  const handleOpenPrintLabel = async () => {
    ...
    try {
      ...
      const fullAccessory = (await response.json()) as AccessoryLabelPrintPayload
