...
-- Insert sample data (you'll need to replace the UUIDs with actual ones from your tables)
-- INSERT INTO public.accessories (name, sku, net_price, vat_id, currency_id, units_id, partners_id) VALUES
-- ('Screws M6x20', 'SCR-M6-20', 50, 'your_vat_id_here', 'your_currency_id_here', 'your_units_id_here', 'your_partners_id_here'),
-- ('Wood Glue 500ml', 'GLUE-500', 1200, 'your_vat_id_here', 'your_currency_id_here', 'your_units_id_here', 'your_partners_id_here'),
-- ('Sandpaper 120 grit', 'SAND-120', 300, 'your_vat_id_here', 'your_currency_id_here', 'your_units_id_here', 'your_partners_id_here')
